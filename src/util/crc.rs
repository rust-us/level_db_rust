...
static K_CRC32_XOR: u32 = 0xffffffff;

const K_BYTE_EXTENSION_TABLE: [u32; 256] = [
...
const K_STRIDE_EXTENSION_TABLE2: [u32; 256] = [
...
const K_STRIDE_EXTENSION_TABLE3: [u32; 256] = [
...
impl<T: Sized> AsCrc for &[T] {
    #[inline]
    fn as_crc_extend(&self, crc: u32) -> u32 {
        let ptr = self.as_ptr() as *const _ as *const u8;
        let buf = unsafe {
...
impl CRC {
    ...
    ///
    /// ```
    ///let crc = CRC::value([1_u8,2,3,4,5].as_ref());
    /// ```
    #[inline]
